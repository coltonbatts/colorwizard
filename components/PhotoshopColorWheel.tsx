        ...
        <div className="color-wheel-panel">
            ...
            <div className="color-wheel-channels">
                <label>
                    ...
                    <input name="color-hue" autoComplete="off" aria-label="Hue" type="range" min="0" max="359" value={Math.round(hsvState.h)} onChange={(event) => updateChannel('h', Number(event.target.value))} />
                </label>
                <label>
                    <span>Saturation <output>{Math.round(hsvState.s)}%</output></span>
                    <input name="color-saturation" autoComplete="off" aria-label="Saturation" type="range" min="0" max="100" value={Math.round(hsvState.s)} onChange={(event) => updateChannel('s', Number(event.target.value))} />
                </label>
                <label>
                    <span>Brightness <output>{Math.round(hsvState.v)}%</output></span>
                    <input name="color-brightness" autoComplete="off" aria-label="Brightness" type="range" min="0" max="100" value={Math.round(hsvState.v)} onChange={(event) => updateChannel('v', Number(event.target.value))} />
                </label>
            </div>
        </div>
    )
