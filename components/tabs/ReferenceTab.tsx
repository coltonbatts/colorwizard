                ...
                {referenceImage ? (
                    <div className="space-y-4">
                        <div className="relative group aspect-square rounded-xl overflow-hidden border border-ink-hairline bg-paper-recessed">
                            ...
                            <img src={resolveTauriImageSrc(referenceImage) ?? referenceImage} alt="Reference overlay" width={640} height={640} className="w-full h-full object-contain" />
                    ...
                    >
                        <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-paper-recessed transition-transform group-hover:scale-110">
                            <svg aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-ink-faint group-hover:text-signal">
