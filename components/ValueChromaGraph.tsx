...
export default function ValueChromaGraph({ color }: ValueChromaGraphProps) {
    ...
    return (
        <div className="w-full bg-gray-900 rounded-lg p-4 border border-gray-800 shadow-inner">
            <h4 className="text-xs font-bold text-gray-400 mb-2 uppercase tracking-wider flex justify-between items-center">
                <span>Perceptual Map</span>
                <span className="text-[10px] text-gray-600 font-normal">Munsell-based</span>
            </h4>
